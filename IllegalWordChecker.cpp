string illegal[] = {"the reader", "situation", "illustrat", "through", "interesting", "simpl", " show", "display", "vivid", "direct", " big ", " huge", " large", "lifestyle", "mindset", "pure", "new heights", "amazing", "impact", "effective", "off of", "plot", "deal with", "deals with", "dealt with", " me ", " my ", " you", " i ", " we ", " our ", " one ", " us ", " goes into", "go into", "went into", "confus", "helps to understand", "later in the novel", "explain", " be ", " is ", " was ", " are ", "been", " were ", " becom", "able to", "very significant", "attitude", "the book", "to not", "constantly", "go through", "up to", "continuously", "go against", "goes against", "went against", "put up with", "puts up with", "heav", "extreme", "in order", "based on", "revolve around", "revolves around", "revolved around", "whilst", " on ", " where ", "however", "base itself", "base oneself", "base themselves", "primarily"};int main()
{
    string word, essay =
